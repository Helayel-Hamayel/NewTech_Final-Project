...
import { ReportFilters, ReportsList, ReportDetails } from "../../helpers/fieldGuard/fieldGuardReportsHelpers";
import { getReportCounts } from "../../helpers/fieldGuard/fieldGuardReportCounts";
import { filterReports } from "../../helpers/fieldGuard/fieldGuardReportFilters";
...
export default function FieldGuardReportsPage() {
  ...
  const selectedReport = filterReports(reports, "All", "All").find(
    ...
    <section className="field-guard-overview" aria-labelledby="reports-title">
      ...
      <dl className="field-guard-stats">
        ...
        <div className="field-guard-stat">
          ...
          <dd>
            <span className="reports-green">{counts.resolved}</span>
            {" / "}
            <span className="reports-red">{counts.rejected}</span>
          </dd>
        </div>
      </dl>
